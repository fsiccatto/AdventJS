## 25 - **El último juego y hasta el año que viene** [<25>](25-ultimoJuego.js)
---
...
El ratoncillo se puede mover en 4 direcciones: _up_, _down_, _left_, _right_ y el comedor es una matriz (un array de _arrays_) donde cada posición puede ser:
